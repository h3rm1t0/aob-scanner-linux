...
Code Patching: Substituição de instruções originais por opcodes arbitrários (ex.: NOPs 0x90) em tempo de execução via pwrite, alterando a lógica do programa sem necessidade de arquivos    ntermediários.
